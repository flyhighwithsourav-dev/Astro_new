// C:\Users\SnowIce\Documents\antigravity\keen-hopper\src\lib\testEngine.js
import { generateHoroscope } from './astrologyEngine.js';
import { generatePredictions } from './plrEngine.js';
import rulesJson from '../data/rules.json' assert { type: 'json' };
...
try {
    ...
    const predictions = generatePredictions(mockHoroscope, rulesJson);
    ...
    // Let's place Saturn in the 10th House (Taurus) to test Lord of 7th in 10th if we have a rule, or let's test Lord of 7th in 1st.
    // In rules.json, we have 'lord_7_house_1' (Lord of 7th in 1st).
    // Leo's 7th house is Aquarius (ruled by Saturn). Let's put Saturn in 1st House (Leo) in a new mock!
    ...
    const predictions2 = generatePredictions(mockHoroscope2, rulesJson);
